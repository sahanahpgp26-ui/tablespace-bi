  ...
  const apis = [
    {
      ...
      status: 'disconnected',
      desc: 'Powers search volume growth signal for expansion scoring',
    ...
    },
    {
      ...
      status: 'disconnected',
      desc: 'Competitor discovery — flex spaces within 3km of each zone',
    ...
    },
    {
      ...
      status: 'calibrated',
      desc: 'Nighttime light intensity — values already manually calibrated (Apr 2026)',
    ...
    },
    {
      ...
      status: 'disconnected',
      desc: 'Enterprise density from company registration data',
      docs: 'https://www.mca.gov.in/content/mca/global/en/mca/master-data.html',
      placeholder: 'mca-...',
      value: '',
    },
    {
      name: 'JLL / Colliers Reports',
      env: 'MARKET_DATA_WEBHOOK',
      field: 'pricing_history, market_share_history',
      status: 'manual',
      desc: 'Quarterly ingestion via PDF parse or manual CSV upload',
      docs: 'https://www.jll.co.in/en/trends-and-insights',
